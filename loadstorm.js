...
import { rand, sample, wpMetrics, sitemap, responseWasCached, bypassPageCacheCookies, findNewAssets, findAssets, filterAssets, filterAssetsArray, createBatchArrayFromURLArray, removeAuthorCategoryLinks, debugObject, generateUsername, checkHttpsProtocol } from './lib/helpers.js'
...
export function setup () {
    ...
    let sitemap = sitemap(`${siteUrl}sitemap.xml`)
